...
summary(data$alt)
```
In 2014 I was somewhere in [woods sowewhere in Romania](https://www.google.ch/maps/place/46°00'00.0%22N+21°48'00.0%22E) in the mean, and [somewhere close to Beromüster](https://www.google.ch/maps/place/47°12'00.0%22N+8°12'00.0%22E) as the median.
...
ggmap(mapImage) +
  geom_point(aes(x = subset(data, lon==min(data$lon))$lon[1],
             ...
             color="darkred",
             size = 10) +
  ggtitle('Most western point in 2014')
````
